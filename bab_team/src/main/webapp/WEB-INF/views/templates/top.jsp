...
<table style="width: 100%">
  <tr>
    <td>
        <img src="${pageContext.request.contextPath}/images/main-03.jpg" width='100%' height='100%'>
    </td>
  </tr>
  ...
  <tr>
    ...
    <ul id="menu">
     ...
     <li><a href="${pageContext.request.contextPath}/img/list">이미지 목록</a></li>
     <li><a href="${pageContext.request.contextPath}/cal/calendar">일정 관리</a></li>
